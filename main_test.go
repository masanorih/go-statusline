...
func TestColorizeUsage(t *testing.T) {
	...
	tests := []struct {
		...
		// 24.9%: 緑、バーは4文字（24.9/100*20=4.98 -> 4）
		{"24.9%は緑でバー4文字", 24.9, "\033[32m24.9% [████                ]\033[0m"},
		// 25%: 黄、バーは5文字
		{"25%は黄色でバー5文字", 25.0, "\033[33m25.0% [█████               ]\033[0m"},
		// 49.9%: 黄、バーは9文字
		{"49.9%は黄色でバー9文字", 49.9, "\033[33m49.9% [█████████           ]\033[0m"},
		// 50%: オレンジ、バーは10文字
		{"50%はオレンジでバー10文字", 50.0, "\033[38;5;208m50.0% [██████████          ]\033[0m"},
		// 74.9%: オレンジ、バーは14文字
		{"74.9%はオレンジでバー14文字", 74.9, "\033[38;5;208m74.9% [██████████████      ]\033[0m"},
		// 75%: 赤、バーは15文字
		{"75%は赤でバー15文字", 75.0, "\033[31m75.0% [███████████████     ]\033[0m"},
		// 99.9%: 赤、バーは19文字
		{"99.9%は赤でバー19文字", 99.9, "\033[31m99.9% [███████████████████ ]\033[0m"},
		// 100%: 赤、バーは20文字
		{"100%は赤でバー20文字", 100.0, "\033[31m100.0% [████████████████████]\033[0m"},
	}
